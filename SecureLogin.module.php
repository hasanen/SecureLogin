...
class SecureLogin extends CMSModule
{
	...
	/*---------------------------------------------------------
	   ...
	   {cms_module module='SecureLogin' param1=val param2=val...}
